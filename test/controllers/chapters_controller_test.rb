...
class ChaptersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chapter" do
    assert_difference('Chapter.count') do
      post chapters_url, params: { chapter: { body: @chapter.body, name: @chapter.name, wiki_id: @chapter.wiki_id } }
    end
  ...
  test "should update chapter" do
    patch chapter_url(@chapter), params: { chapter: { body: @chapter.body, name: @chapter.name, wiki_id: @chapter.wiki_id } }
